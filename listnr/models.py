...
class Song(models.Model):
    ...
    artist = models.ForeignKey(Listnr, on_delete=models.CASCADE, related_name='songs'  )
...
class Review(models.Model):
    ...
    artist = models.ForeignKey(Listnr, on_delete=models.CASCADE, related_name='reviews')
